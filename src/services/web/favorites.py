...
from schemas.favorites import GetFavoritesGoodSchema, GetFavoritesSchema, DeleteFavoritesSchema
...
class FavoritesService:
    ...
    async def add_good(self, cart_outlet_guid: str, good_guid: str) -> Favorites:
    ...
    async def delete_good(self, cart_outlet_guid: str, good_guid: str) -> DeleteFavoritesSchema:
