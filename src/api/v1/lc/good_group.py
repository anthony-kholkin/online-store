...
@router.get("", status_code=status.HTTP_200_OK, response_model=list[GoodGroupSchema])
...
@router.get("/{guid}", status_code=status.HTTP_200_OK, response_model=GoodGroupSchema)
