...
@router.post("", status_code=status.HTTP_201_CREATED, response_model=PriceTypeSchema)
...
@router.get("", status_code=status.HTTP_200_OK, response_model=list[PriceTypeSchema])
...
@router.get("/{guid}", status_code=status.HTTP_200_OK, response_model=PriceTypeSchema)
